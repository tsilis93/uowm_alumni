...
echo		'<option value="'.$number.'">Ανακοίνωση που αφορά το Πανεπιστήμιο</option>';
echo		'<optgroup label="Ανακοίνωση που αφορά το">';
...
function validate()  
{
	...
	if (title == '' || description == '' || body == '' || department == '') {
		if (w < 768) {
			mcxDialog.alert("Παρακαλώ συμπληρώστε όλα τα πεδία προτού προχωρήσετε στην δημοσίευση της ανακοίνωσης");
		}
		else 
		{
			alert("Παρακαλώ συμπληρώστε όλα τα πεδία προτού προχωρήσετε στην δημοσίευση της ανακοίνωσης");
		}
		return false;
	}
	return true;
