...
<head>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/js/bootstrap-select.min.js"></script>
		...
		<link rel="stylesheet" href="../css/admin_alumni_search.css">
...
<div align="center">
<p id = "header">Αναζήτηση - Επεξεργασία <br> Αποφοίτων <span class="glyphicon" style="color:white" onmouseOver = "mouseOver()" onmouseout="mouseOut()">&#xe086;</span></p>
<div id = "info"></div>
</div>
...
function delete_alumni(id)
{
	...
	if (w < 768) 
	{	
		mcxDialog.confirm("Θέλετε σίγουρα να διαγράψετε τον απόφοιτο?", {
			sureBtnText: "OK",  
			sureBtnClick: function(){  
				...
				$.post("delete_alumni.php", {
					...
					mcxDialog.alert("Ο απόφοιτος διαγράφτηκε με επιτύχια");
					location.reload();
				});
	...
	{
		var response = confirm("Θέλετε σίγουρα να διαγράψετε τον απόφοιτο?");
		...
		if (response == true) {
			...
			$.post("delete_alumni.php", {
				...
				alert("Ο απόφοιτος διαγράφτηκε με επιτύχια");
				location.reload();
			}); 
...
function jsfunction()
{						// η συναρτηση επιστρέφει τα δεδομένα από το query που πραγματοποίησε ο διαχειριστής
...
{	
	window.location.href = "download_csv.php?query="+query;
}
