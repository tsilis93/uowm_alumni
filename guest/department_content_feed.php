...
$rssfeed .= '<channel>'  . "\n\n\t";
$rssfeed .= '<title>Department index page Announcements feed</title>'  . "\n\t";
$rssfeed .= '<link>'.$link.'</link>'  . "\n\t";
$rssfeed .= '<description>This is a RSS feed for department index page Announcements</description>'  . "\n\t";
